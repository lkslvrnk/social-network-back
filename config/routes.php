...
return function (App $app) {
    ...
    $app->post('/api/tokens', \App\Controller\TokenCreateControllerHS256::class);
    $app->get('/changeAvatar', "$userController:getAvatarChangePage");
    //$app->get('/signup', SignUpController::class . ':getSignUpFormNew');
//    $app->post('/signup', SignUpController::class . ':signUp')->add(JwtAuthMiddleware::class);
    $app->get('/chpr', SettingsController::class . ":getPrivacyChangePage");
    
    $app->group('/users', function (Group $group) use($userController) {
    ...
    $app->group('/user-bans', function (Group $group) {
        $group->post('', UserController::class . ":createBan");
        $group->patch('/{id}', UserController::class . ":updateBan");
    });
    
    $app->group('/saves-collections', function (Group $group) use($userController)  {
    ...
    $app->group('/user-subscriptions', function (Group $group) {
    ...
    $app->group('/user-post-photos', function (Group $group) {
    ...
    $app->group('/user-comment-photos', function (Group $group) {
    ...
    $app->get('/posts', CommonController::class . ':getPosts');
    $app->get('/feed', CommonController::class . ':feed');
    
    $app->get('/privacy', SettingsController::class . ':getPrivacy');
    $app->patch('/privacy', SettingsController::class . ':updatePrivacy');
    
    $propExp = 'info|tagged_photos|hidden_friends';
    $app->patch("/privacy/{propertyName:$propExp}", SettingsController::class . ':updatePrivacySetting');
    
    
    $app->group('/connections', function (Group $group) {
    ...
    $app->patch('/accept-connection', ConnectionsController::class . ':accept');
    $app->patch('/accept-membership', \App\Controller\GroupController::class . ':acceptMembership');
    $app->patch('/delete-membership', \App\Controller\GroupController::class . ':deleteMembership');
    
    $app->group('/connections-lists', function (Group $group) {
        $group->post("", ConnectionsController::class . ':createList');
    });

    
    $app->get("/search", UserController::class . ':search')->add(JwtAuthMiddleware::class);
    
    $app->post("/saved-photos", PhotosController::class.':savePhoto');
    $app->post("/profile-avatars", PhotosController::class.':createProfilePhoto');
    
    $app->group('/groups', function (Group $group) use($userController) {
...
//        $group->post('/{id}/avatar', "$userController:changeAvatar");
    ...
    $app->group('/group-posts', function (Group $group) {
    ...
    $app->group('/temp-photos', function (Group $group) {
        $group->post('', \App\Controller\UserController::class . ":createTempPhoto");
    });
    
    $app->group('/pages', function (Group $group) {
    ...
    $app->group('/friendship_requests', function (Group $group) {
...
//        });
    ...
    $app->group('/friendships', function (Group $group) {
    ...
    $app->group('/dialogues', function (Group $group) {
    ...
    $app->group('/messages-histories', function (Group $group) {
    ...
    $app->group('/profile-pictures', function (Group $group) {       
...
//    
//    $app->group('/user-photos', function (Group $group) {
...
//    });
    ...
    $app->group('/user-photo-comments', function (Group $group) {
...
//        $group->get("", UserPostsController::class.':getProfilePosts');
    ...
    $app->group('/page-posts', function (Group $group) {
...
//        $group->get("", UserPostsController::class.':getProfilePosts');
    ...
    $app->group('/suggested-posts', function (Group $group) {
        $group->patch("/{id}", PagePostsController::class.':patchSuggested');
    });
    
    $app->group('/page-post-comments', function (Group $group) {
    ...
    $app->group('/user-post-comments', function (Group $group) {
        //$group->get("/{id}", UserPostsController::class.':getPost')->add(JwtAuthMiddleware::class);
        //$group->patch("/{id}", UserPostsController::class.':updatePost');
    ...
    $app->group('/group_posts', function (Group $group) {
        $group->get("/{id}", UserPostsController::class.':getGroupPost');
    });

    
    $app->group('/user-albums', function (Group $group) {
