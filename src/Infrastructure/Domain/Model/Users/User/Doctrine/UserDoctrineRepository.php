...
//            ->findBy(array('username.username' => $username));
    ...
    function getCommonContacts(User $user, User $commonWith, ?string $cursor, int $count) {
        ...
        return $this->getContactsByIds($common, $cursor, $count);
    }
    ...
    function getUserContacts(User $user, ?string $cursor, int $count) {
        ...
        return $this->getContactsByIds($contactsIds, $cursor, $count);
    }
    ...
    public function getContactsByIds(array $ids, ?string $cursor, int $count) {
        $qb = $this->entityManager->createQueryBuilder();
        $query = $qb
            ->select('u')
            ->from(User::class, 'u')
