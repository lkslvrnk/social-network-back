...
final class ServerErrorsHandlerMiddleware implements MiddlewareInterface
{
    ...
    public function __construct(ResponseFactoryInterface $responseFactory, LoggerFactory $loggerFactory, bool $showMessage)
    {
    ...
    ): ResponseInterface
    {
        ...
        set_error_handler(
            function ($errno, $errstr, $errfile, $errline) {
                ...
                if(!$this->showMessage) { $errorMessage = "Internal server error"; }   
